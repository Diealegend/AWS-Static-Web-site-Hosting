...
Create the main S3 bucket which must have the same name as the website you ate hosting:
 <br/>
<img src="https://i.imgur.com/K255W9n.png" height="80%" width="80%" alt="Static Website"/>
<img src="https://i.imgur.com/cbH8Haw.png" height="80%" width="80%" alt="Static Website"/>
<img src="https://i.imgur.com/LUUfUUg.png" height="80%" width="80%" alt="Static Website"/>


<br />
<br />
Then allow this Bucket to be publicly available on the Internet:<br/>
<img src="https://i.imgur.com/SYVtznk.png" height="80%" width="80%" alt="Static Website"/>
...
The main Bucket is now created, it is time to install the files of your website. To do this, go to your Bucket and click on Upload:
 <br/>
<img src="https://i.imgur.com/3WVITlS.png" height="80%" width="80%" alt="Static Website"/>
...
<img src="https://i.imgur.com/1ppoea6.png" height="80%" width="80%" alt="Static Website"/>
...
Apply the new bucket policy the pages of the website will now be publicly accessible. It should say publicly accessible: 
 <br/>
<img src="https://i.imgur.com/VAYKCBp.png" height="80%" width="80%" alt="Static Website"/>


<br />
<br />
Activate your static website, and indicate the name of your index (index.html) and error (error.html) documents:  <br/>
<img src="https://i.imgur.com/ehPBySx.png" height="80%" width="80%" alt="Static Website"/>
...
<img src="https://i.imgur.com/vFrpx0x.png" height="80%" width="80%" alt="Static Website"/>
<img src="https://i.imgur.com/JrgrE5F.png" height="80%" width="80%" alt="Static Website"/>

<br />
<br />
Nextstep is copying the same steps with the redirect bucket.Start by creating the www. Bucket (www.navigateproject.link).   <br/>
<img src="https://i.imgur.com/qZ77zE8.png" height="80%" width="80%" alt="Static Website"/>
